...
?>
		...
		<div class="sellers">
			<h4><span><span>Identitas Pemesan</span></span></h4>
		</div>
		<div class="row">
			<div class="col-sm-3">
				<div class="shopper-info">
					...
					<form>
						<input class="form-control"type="text" disabled="disabled" value="Nomor : <?php echo $row->no_order;?>">
						<br />
			...
			<div class="col-sm-3">
				<div class="shopper-info">
					<?php foreach($order as $row):?>
					<form>
						<input class="form-control" type="text"disabled="disabled" value="Pemesan : <?php echo $row->nama_member;?>">
						<br />
			...
			<div class="col-sm-4">
				...
				<div class="shopper-info">
					<?php foreach($order as $row):?>
					<textarea class="form-control"name="message" disabled="disabled"><?php echo $row->alamat_kirim;?></textarea>
			...
			<div class="col-sm-2">
				...
				<br />
					<?php foreach($order as $row):?>
					<a target="_blank" class="btn btn-lg btn-primary pull-right" href="<?php echo site_url('admin/laporan/nota_order/'.$row->id_order);?>"><i class="glyphicon glyphicon-print"></i> <br />
					Cetak</a>
					<?php endforeach;?>
				</div>
			</div>
