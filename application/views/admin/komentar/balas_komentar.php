                ...
                <div class="box-body">
				  	<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								<label class="col-sm-5 control-label">Tgl Komentar</label>
								<div class="col-sm-5">
									<input type="text" value="<?php echo $balasan->tgl_komentar;?>"  class="form-control" readonly="">
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-5 control-label">Komentar</label>
								<div class="col-sm-5">
									<textarea class="form-control"rows="5" disabled="disabled"><?php echo $balasan->isi_komentar;?></textarea>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<input type="hidden" value="<?php echo $balasan->id_komentar;?>" name="id_komentar" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-3 control-label">Balas Komentar</label>
								<div class="col-sm-7">
									<textarea name="isi_balasan" rows="5" class="form-control"><?php echo $balasan->isi_balasan;?></textarea>
								</div>
							</div>
							<br />&nbsp;
					...
					<div class="box-footer">
							...
							<a href="<?php echo site_url('admin/komentar/index');?>" class="btn btn-danger">Cancel</a>
							</div>
				</div>
			</form>
	        </div>
