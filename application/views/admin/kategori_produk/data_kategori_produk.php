          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
					...
					<?php foreach($kategori as $row):?>
					  ...
					  <td><?php echo $i++;?></td>
                        ...
                        <td style="text-align:center;">
						  <a class="btn btn-xs btn-info" title="Edit" href="<?php echo site_url('admin/kategori_produk/edit_kategori_produk/'.$row['id_kategori_produk']);?>"><i class="glyphicon glyphicon-pencil"></i></a>
						  <a class="btn btn-xs btn-danger" title="Hapus" href="<?php echo site_url('admin/kategori_produk/delete_kategori_produk/'.$row['id_kategori_produk']);?>"onclick="return confirm('Anda Yakin ?')">
				...
				<a class="btn btn-medium btn-success" href="<?php echo site_url('admin/kategori_produk/add_kategori_produk');?>">Tambah</a>
