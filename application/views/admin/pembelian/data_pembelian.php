					...
					<?php foreach($pembelian as $row):?>
					  ...
					  <td><?php echo $i++;?></td>
                        ...
                        <td style="text-align:center;">
						  <a class="btn btn-xs btn-info" title="Detil" href="<?php echo site_url('admin/pembelian/edit_beli/'.$row->id_beli);?>"><i class="glyphicon glyphicon-pencil"></i> </a>
						 
						  <a class="btn btn-xs btn-success" target="_blank" title="Cetak" href="<?php echo site_url('admin/laporan/nota_pembelian/'.$row->id_beli);?>"><i class="glyphicon glyphicon-print"></i></a>
						</td>
                      </tr>
					 <?php endforeach;?>
                    </tbody>
				  	...
				  	<table width="100%">	
						<tr>
							<td>
								<a class="btn btn-success" href="<?php echo site_url('admin/pembelian/add_beli');?>">Tambah</a>
							</td>
