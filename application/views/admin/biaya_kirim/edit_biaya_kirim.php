				  	...
				  	<div class="row">
						<div class="col-md-6">
							<div class="form-group">
							  ...
							  <div class="col-sm-6">
						<input type="text" class="form-control" value="<?php echo $biaya_kirim->nama_kota;?>" name="nama_kota">
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-6">
						<input type="text" class="form-control" value="<?php echo $biaya_kirim->biaya;?>" name="biaya">
