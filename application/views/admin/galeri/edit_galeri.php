	...
	<div class="row">
       <div class="col-md-12">
           <div class="box box-primary">
                ...
                <!-- form start -->
                <div class="box-body">
				<?php echo form_open_multipart('admin/galeri/edit_galeri'); ?>
				  	<div class="row">
						<div class="col-md-8">
							<div class="form-group">
							  <label class="col-sm-3 control-label">Judul Galeri</label>
							  <div class="col-sm-9">
						<?php echo form_input(array('name'=>'judul_galeri','value'=>set_value('judul_galeri',isset($galeri['judul_galeri']) ? $galeri['judul_galeri'] : ''),'class'=>'form-control')); ?>
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-5">
						<input type="text" id="datepicker" value="<?php echo $galeri['tgl_posting'];?>" class="form-control" name="tgl_posting">
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-0">							  
									...
									&nbsp;&nbsp;&nbsp;
									  ...
									  <?php }else{?>
									  <img src="<?php echo base_url().$galeri['image'];?>"width="40" height="30" />
									  <?php }?>
									</td>
									<td valign="bottom">
				...
				<?php echo form_textarea(array('name' => 'keterangan', 'value' => set_value('keterangan', isset($galeri['keterangan']) ? $galeri['keterangan'] : ''),'class'=>'form-control')); ?>
