    	...
    	<div class="col-xs-12">
        	<div class="box">
				 ...
				 <table id="example2" class="table table-bordered table-hover">
				  ...
				  <?php foreach($galeri as $row):?>
					<tr>
					  ...
					  <td>
						  <a class="btn btn-xs btn-info" href="<?php echo site_url('admin/galeri/edit_galeri/'.$row->id_galeri);?>"><i class="glyphicon glyphicon-pencil"></i></a>
						  <a class="btn btn-xs btn-danger" href="<?php echo site_url('admin/galeri/delete_galeri/'.$row->id_galeri);?>"onclick="return confirm('Anda Yakin ?')">
				...
				<table width="100%">
					<tr>
						<td>
							<a class="btn btn-success"href="<?php echo site_url('admin/galeri/add_galeri');?>"><i class="icon-plus"></i> Tambah</a>
						</td>
						<td align="right">
							<ul class="pagination">
