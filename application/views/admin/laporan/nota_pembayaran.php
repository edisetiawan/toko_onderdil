...
?>
		...
		<div class="row" style="width:58%;">
			...
			<div class="col-sm-4" style="width:35%;">
				...
				<div class="shopper-info">
					<?php foreach($nota_order as $row):?>
					<textarea style="width:248px;" rows="3"class="form-control"name="message" disabled="disabled"><?php echo $row->alamat_kirim;?></textarea>
		...
		<div class="sellers">
			...
			<div class="table-responsive cart_info">
				<table id="example2" class="table table-bordered table-hover" style="width:58%;">
					...
					<tbody>
						<?php $i=1;?>
						<?php foreach($detil_order as $row):?>
						<tr>
						...
						<tr>
							<td colspan="3">
								...
								<h2><?php echo $row->status_bayar;?></h2>
							</td>
							<td colspan="3">
								<table class="table table-condensed total-result" style=" background-color:#D7DBDE;">
									<tr>
									...
									<tr>
										<td>JML Bayar</td>
										<td style="text-align:right">
											<?php echo $this->fungsi->rupiah($row->jml_bayar);?>
										</td>
									</tr>
									<tr class="shipping-cost">
										<td>Kekurangan</td>
										<td style="text-align:right"><?php echo $this->fungsi->rupiah($row->jml_bayar -$row->tagihan);?></td>										
									</tr>
