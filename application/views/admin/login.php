  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <img src="<?php echo base_url();?>public/logo-sigit.png">
		
      </div><!-- /.login-logo -->
      <div class="login-box-body">
	  	
         <h3><p class="login-box-msg"><b>Login Administrator</b></p></h3>
        <form action="<?php echo site_url('admin/home/login');?>" method="post">
        ...
        <a href="../../../AdminLTE/pages/examples/register.html" class="text-center">Register a new membership</a>
