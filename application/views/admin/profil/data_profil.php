    ...
    <div class="row">
    	<div class="col-xs-12">
        	<div class="box">
				 ...
				 <table id="example2" class="table table-bordered table-hover">
				  <thead>
					<tr>
					  ...
					  <th style="text-align:center;">Judul Profil</th>
					  <th style="text-align:center;">Image</th>
					  <th style="text-align:center;">Isi Profil</th>
				  ...
				  <?php foreach($profil as $row):?>
					<tr>
					  ...
					  <td><?php echo $row->judul_profil;?></td>
					  <td>
					  <?php if($row->image == ""){?>
					  ...
					  <td><?php echo word_limiter($row->isi_profil,5);?></td>
					  <td><?php echo $row->nama_lengkap;?></td>
					  <td>
						  <a class="btn btn-xs btn-info" href="<?php echo site_url('admin/profil/edit_profil/'.$row->id_profil);?>"><i class="glyphicon glyphicon-pencil"></i></a>
						  <a class="btn btn-xs btn-danger" href="<?php echo site_url('admin/profil/delete_profil/'.$row->id_profil);?>"onclick="return confirm('Anda Yakin ?')">
				...
				<a class="btn btn-success"href="<?php echo site_url('admin/profil/add_profil');?>"><i class="icon-plus"></i> Tambah</a>
