       	...
       	<div class="box">
            ...
            <div class="box-body">	
				<?php foreach($suplier as $row):?>
					<?php $id_suplier = $row->id_suplier;?>
					
					<?php $id_beli = $row->id_beli;?>
				<?php endforeach;?>
				<?php $id_beli = $id_beli;?>
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input class="form-control" type="text" name="jml_beli" />
						</div>
					</div>
				</div>
				...
				<div class="box-footer">
					...
					<button name="btn" id="btn" type="submit"onsubmit="submit(); window.close()" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-plus"></i> Beli</button>
